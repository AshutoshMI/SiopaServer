...
import siopa.ashu.androidsiopaserver.Model.Category;
import siopa.ashu.androidsiopaserver.Model.Token;
import siopa.ashu.androidsiopaserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    private void deleteCategory(String key) {
        ...
        com.google.firebase.database.Query foodInCategory = (com.google.firebase.database.Query) foods.orderByChild("menuId").equalTo(key);
